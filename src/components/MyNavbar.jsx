...
const pages = [{title: "dashboard",

url: "/"},
{title:"newblog", url: "/newblog"},
{title:"about", url: "/about"}];


// !currentUser ?
const settings = {anAuth:[{
          ...
          <Box sx={{ flexGrow: 0 }}>
            ...
            >
              {!currentUser ? settings.anAuth.map((setting,index) => (
                ...
                <MenuItem key={setting.title} onClick={()=>setting.url==="logout" ? logout(): navigate(setting.url)}>
                  <Typography textAlign="center">{setting.title}</Typography>
                </MenuItem>
              ))}
            </Menu>
